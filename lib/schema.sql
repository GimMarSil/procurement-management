-- Procurement Management - SQL Server Schema
-- Run this script to create all required tables.

-- Articulado Lines (bill of quantities)
...
-- Response Items (line items within a supplier response)
...
-- Response Mappings (link response items to articulado lines)
